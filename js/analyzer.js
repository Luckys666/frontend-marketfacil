...
function exibirTendenciaVisitas(visitsData, containerId = "visitsTrend") {
    ...
    // Só mostra % se o dataset cobre o período da comparação (sem dado anterior, % é enganoso)
    const percentChange7 = _oldestAge >= 14 ? calcPct(total7, totalPrev7) : null;
    const percentChange15 = _oldestAge >= 30 ? calcPct(total15, totalPrev15) : null;
    const percentChange30 = _oldestAge >= 60 ? calcPct(total30, totalPrev30) : null;
